...
for i in xrange(Cycles):
    ...
    # Save values to disk
    msg = Mode.message
    update_file(path_VAR1, (time_since_start, time_for_sweep,
                            "%s %s" % (VAR1_current, msg)), VAR1_total)
    update_file(path_VAR2, (time_since_start, time_for_sweep,
                            "%s %s" % (VAR2_current, msg)), VAR2_total)
