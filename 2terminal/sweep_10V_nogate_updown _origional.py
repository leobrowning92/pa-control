...
numReadings = abs((float(VAR1_start) - float(VAR1_stop)) / float(VAR1_step)) * int(VAR2_number_of_steps)
...
pressure = 15000 # Pressure to set the pump in mbar
