...
PATH = ("C:\Users\cleanroom.STAFF\Desktop\Leo\\2016-04-05_COL181-189_dense95CNTdevices\\" + timeStampYMDH() + "_")

## Filename to save the file
## Modify this filename but
## leave as *.csv so you can open in excel :)
FILENAME = "COL181_2_diode.csv" # values in the array values will be appended to the front of this
